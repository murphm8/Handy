...
export const BedrockProfileField: React.FC<BedrockProfileFieldProps> = React.memo(
...
export const BedrockCustomModelField: React.FC<BedrockCustomModelFieldProps> = React.memo(
  ({ value, onBlur, placeholder, className = "" }) => {
    const [localValue, setLocalValue] = useState(value);
